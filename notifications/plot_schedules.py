...
from notifications.calculate_schedule_times import GreedyScheduleCalculator, SegmentedScheduleCalculator, ScheduleCalculatorBase, WeightedAverageSegmentedCalculator
...
if __name__ == "__main__":
    ...
    log25 = [
        ("12:00", 500), ("13:00", 400), ("14:30", 300), ("16:00", 400), ("17:30", 300),
        ("12:10", 520), ("13:15", 380), ("14:20", 320), ("16:05", 390), ("17:40", 310),
        ("12:05", 510), ("13:05", 410), ("14:35", 290), ("16:10", 400), ("17:25", 295),
        ("12:00", 500), ("13:00", 400), ("14:30", 310), ("16:15", 390), ("17:30", 310),
        ("12:15", 530), ("13:10", 395), ("14:25", 305), ("16:20", 405), ("17:35", 300)
    ]
    log26 = [
        ("07:00", 80), ("08:00", 90), ("09:00", 85), ("10:00", 75), ("11:00", 95),
        ("12:00", 80), ("13:00", 90), ("14:00", 85), ("15:00", 100), ("16:00", 80),
        ("17:00", 95), ("18:00", 85), ("19:00", 90), ("20:00", 85), ("21:00", 75),
    ] * 5

    log27 = [
        ("02:00", 500), ("06:00", 400), ("11:00", 600), ("16:00", 500),
        ("02:15", 520), ("06:10", 390), ("11:05", 610), ("16:20", 480),
        ("02:05", 510), ("06:00", 400), ("11:15", 590), ("16:10", 510),
        ("02:00", 500), ("06:05", 420), ("11:10", 600), ("16:00", 490),
        ("02:20", 530), ("06:15", 395), ("11:20", 605), ("16:25", 500)
    ]
    ...
    log28 = [
        ...
        ("08:00", 200), ("12:00", 300), ("18:00", 250),
        # Day 2 (light)
        ("08:10", 220), ("12:10", 280), ("18:10", 270),
        # Day 3 (light)
        ("08:00", 210), ("12:00", 290), ("18:00", 260),
        # Day 4 (heavy - Saturday)
        ("09:00", 600), ("13:00", 800), ("19:00", 900),
        # Day 5 (heavy - Sunday)
        ("09:30", 650), ("13:30", 850), ("19:30", 950)
    ]

    log29 = [
        ("11:00", 700), ("14:00", 200), ("17:00", 150), ("20:00", 150),
        ("11:10", 680), ("14:10", 220), ("17:15", 140), ("20:05", 160),
        ("11:05", 690), ("14:05", 210), ("17:10", 150), ("20:10", 155),
        ("11:00", 700), ("14:00", 200), ("17:00", 150), ("20:00", 150),
        ("11:15", 710), ("14:15", 190), ("17:20", 145), ("20:15", 160)
    ]
    ...
    log31 = [
        ("06:00", 200), ("08:00", 300), ("10:00", 250), ("12:00", 400), ("13:30", 200),
        ("06:05", 220), ("08:05", 280), ("10:10", 260), ("12:05", 390), ("13:40", 210),
        ("06:00", 210), ("08:00", 290), ("10:00", 240), ("12:00", 410), ("13:30", 200),
        ("06:10", 205), ("08:15", 295), ("10:05", 245), ("12:15", 395), ("13:45", 220),
        ("06:00", 215), ("08:00", 300), ("10:00", 255), ("12:00", 405), ("13:35", 205)
    ]
